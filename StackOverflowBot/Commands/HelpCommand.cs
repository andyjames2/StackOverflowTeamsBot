    ...
    public class HelpCommand : ICommand
    {
        ...
        public async Task<bool> Do(IEnumerable<string> args)
        {
            ...
            activity.Text = "@ me or message me directly to tell me what to do. Here's what I can do:\n\n\r\n\u00A0\n\n\r\n" +
                "**subscribe** - Subscribe to all new questions and answers on registered Stack Overflow teams.\n\n\r\n" +
                ...
                "**register** - Register a new Stack Overflow team to get new questions and answers from.\n\n\r\n" +
                "**unregister** - Stop receiving new questions and answers from a Stack Overflow team.\n\n\r\n" +
